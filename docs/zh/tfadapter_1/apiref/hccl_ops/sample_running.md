...
1. 准备rank table文件。
    ...
    不同产品形态rank table文件的配置示例及详细参数说明可参见《[HCCL集合通信库用户指南](https://hiascend.com/document/redirect/CannCommunityHcclUg)》。
...
2. 构造启动脚本。
    ...
    export RANK_SIZE=8
    export RANK_TABLE_FILE=/home/test/ranktable.json    # rank table资源配置文件路径，请根据实际情况替换
