...
Whether to generate the operator fusion result file fusion_result.json during graph compilation. 
...
- ub_fusion: UB fusion. The Ascend 950PR/Ascend 950DT does not support UB fusion, and therefore this information is not generated.
  ...
  **The Ascend 950PR/Ascend 950DT does not support UB fusion and therefore does not generate this information**.
