...
> - When this parameter is used to set the precision mode of the entire network, some operators may have precision problems. In this scenario, call [keep_dtype_scope](../../npu_scope/keep_dtype_scope.md) to set some operators to retain the original image precision.
