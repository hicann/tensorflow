...
- Communicator management APIs: Include  **create_group**,  **destroy_group**,  **get_rank_size**, and  **get_rank_id**. For details, see  APIs \> HCCL APIs \> Communicator Management \> Python APIs  in  [Huawei Collective Communication Library \(HCCL\)](https://www.hiascend.com/document/detail/en/CANNCommunityEdition/latest/API/hcclug/hcclug_000001.html).
