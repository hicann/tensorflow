...
class NPURunConfig(run_config_lib.RunConfig):
    ...
    def __init__(self,
        ...
        compile_dynamic_mode:compile graph with dynamic shape.
        graph_max_parallel_model_num:max parallel model num
        ...
        input_batch_cpy: The switch of batch mem copy, False: disable; True(default): enable.
        shape_generalization_mode: Work on jit_compile=1, jit_compile=0/2 will ignore this config.
                                   STRICT: default, use the input shape;
        ...
        self._input_fusion_size = input_fusion_size
        self._compile_dynamic_mode = compile_dynamic_mode
        ...
        self._oo_constant_folding = oo_constant_folding
        ...
        self._oo_level = oo_level
        self._optimization_switch = optimization_switch
...
class MemoryConfig():
    ...
    def __init__(self,
        ...
        Args:
            ...
            variable_use_1g_huge_page: variable_use_1g_huge_page.
        """
        ...
        self._variable_use_1g_huge_page = variable_use_1g_huge_page
...
class DynamicInputConfig():
    ...
    def __init__(self, input_shape, dynamic_dims, dynamic_node_type, compile_hybrid_mode):
        """
        ...
        Args:
            ...
            compile_hybrid_mode: Dynamic gear hybrid compilation switch (0/1), currently placeholder-only.
        """
        self._input_shape = input_shape
        self._dynamic_dims = dynamic_dims
        self._dynamic_node_type = dynamic_node_type
        self._compile_hybrid_mode = compile_hybrid_mode
