...
TEST(KMeansCentroidsOpTest, TestKMeansCentroids) {
    std::vector<DataType> in_types_vec = {DT_FLOAT, DT_FLOAT, DT_FLOAT, DT_FLOAT};
    DataTypeSlice input_types(in_types_vec);
    MemoryTypeSlice input_memory_types;
    std::vector<DataType> out_types_vec = {DT_FLOAT, DT_FLOAT, DT_FLOAT};
    ...
    ASSERT_FALSE(k_means_centroids.IsExpensive());
    delete device;
    delete node_def;
    delete op_def;
    delete context;
