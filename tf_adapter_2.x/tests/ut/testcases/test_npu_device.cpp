...
class EagerOpBuilderHelper {
 ...
 public:
  ...
  std::shared_ptr<EagerOpResult> EXPECT_RunExpectStatus(TF_Code expected_code) {
...
class ST_NpuDevice : public ::testing::Test {
 ...
 protected:
  void SetUp() override {
    ...
    npu::CreateDevice(context, kNpuDeviceName, kNpuDeviceIndex, global_options, session_options);
