...
npu_device.global_options().compile_dynamic_mode = True
npu_device.global_options().jit_compile = "false"
npu_device.global_options().shape_generalization_mode = "FULL"
...
class Adapter2ShapeGeneralizationModeIgnoreSt(unittest.TestCase):
