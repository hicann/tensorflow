...
class NpuConcreteGraph : public OpExecutor {
 public:
  ...
  const std::map<int, std::shared_ptr<IteratorResourceProvider>> &ConsumedIterators() const {
  ...
  void SetFunctionOpFlag(bool is_function_op) const { function_op_ = is_function_op; }
