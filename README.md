...
![tfadapter](docs/figures/tfadapter_overview.png)
...
TF Adapter支持的TensorFlow版本为TensorFlow 1.15与TensorFlow 2.13.0。
...
若您的TensorFlow框架版本是2.13.0，本源码仓的编译安装等详细使用方法请参见[tf_adapter 2.x](./tf_adapter_2.x/README.md)。
